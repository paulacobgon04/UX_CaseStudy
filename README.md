...
1 — Paleta de colores — El rosa oscuro #8B2252 es el color protagonista (botones primarios, encabezados, navBar). Se apoya en una escala de rosas hasta el blanco roto como fondo, con dorado #C9882A como acento para destacar precios o elementos especiales.

2 — Tipografía — Se propone Playfair Display para títulos y marca (evoca elegancia japonesa sin ser genérico), y DM Sans para todo el cuerpo, formularios y botones. Es una combinación que equilibra identidad visual con legibilidad en móvil.
3-4 — Botones y formularios — Cuatro estados de botón (primario, secundario, confirmar/pagar, desactivado) coherentes con lo que ya aparece en los wireframes. Los campos de formulario tienen cuatro estados visibles: vacío, activo, error y válido.

5 — Tarjeta de plato — Basada en el wireframe de la Carta. Se añade estructura interna clara: imagen, nombre, ingredientes, badge opcional, precio y CTA. También se define cómo se ve un ítem ya dentro del carrito.

6 — Navegación — Se formaliza el patrón que ya intuíais: barra superior en desktop y barra inferior fija en móvil, con el ítem activo visualmente diferenciado.

7–8 — Iconografía, badges y patrones de UI — Se documentan los 6 patrones principales extraídos de vuestros flujos: Onboarding, Article List, Bottom Nav, Wizard de reserva, Form Input e Item details + carrito.
